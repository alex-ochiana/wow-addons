...
local function LoadSkinsPanel(sWindow)
    ...
    addOption(p.scroll.scrollchild, L["Chromie Time Frame"], nil, "CHROMIE_TIME_SKIN_ENABLED")
    addOption(p.scroll.scrollchild, L["Allied Races"], nil, "ALLIEND_RACES_UI_SKIN_ENABLED")
