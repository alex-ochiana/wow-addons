...
local function SkinBubble(frame, backdrop)
    ...
    frame.background:SetTexture("Interface/AddOns/GW2_UI/textures/chat/ChatBubble-Background")
    ...
    frame.bordertop:SetTexture("Interface/AddOns/GW2_UI/textures/chat/bubble-top")
    ...
    frame.borderbottom:SetTexture("Interface/AddOns/GW2_UI/textures/chat/bubble-bottom")
    ...
    frame.borderright:SetTexture("Interface/AddOns/GW2_UI/textures/chat/bubble-right")
    ...
    frame.borderleft:SetTexture("Interface/AddOns/GW2_UI/textures/chat/bubble-left")
    ...
    frame.bordertopright:SetTexture("Interface/AddOns/GW2_UI/textures/chat/bubble-corner-top-right")
    ...
    frame.borderbottomright:SetTexture("Interface/AddOns/GW2_UI/textures/chat/bubble-corner-bottom-right")
