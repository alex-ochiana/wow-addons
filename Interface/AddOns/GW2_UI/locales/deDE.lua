...
L["Left Click to switch between Local and Realm time"] = "Links Klick zum wechseln zwischen Lokaler- und Serverzeit "
L["Shift-Click to toggle military time format"] = "Shift-Klick zum umschalten in das militärische Zeitformat."
L["Right Click to open the Stopwatch"] = "Rechts Klick zum öffnen der Stoppuhr"
L["Shift-Right Click to open the Time Manager"] = "Shift-Rechts Klick zum öffnen der Zeit Einstellungen"
...
L["You cannot upgrade that item."] = "Du kannst dieses Item nicht aufwerten."
...
L["Scale"] = "Skalierung"
L["Stance Bar Position"] = "Position der Stancebar"
L["Set the position of the stance bar (left or right from the main action bar)."] = "Setze die Position der Stancebar (Links oder recht von der Hauptaktionsleiste)"
...
L["You must unequip that item in order to upgrade it."] = "Du musst das Item erst ausziehen, bevor du es aufwerten kannst."
L["Up"] = "Hoch"
