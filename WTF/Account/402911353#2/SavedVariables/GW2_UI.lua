...
GW2UI_SETTINGS_PROFILES = {
	[0] = {
		...
		["BAG_POSITION"] = {
			["yOfs"] = 835.0001831054688,
			["xOfs"] = 1468.999877929688,
			["point"] = "TOPLEFT",
			["relativePoint"] = "BOTTOMLEFT",
		},
		["castingbar_pos"] = {
		...
		["HERO_POSITION"] = {
			["yOfs"] = 316.9999389648438,
			["xOfs"] = 412.0000610351563,
			["point"] = "BOTTOMLEFT",
			["relativePoint"] = "BOTTOMLEFT",
		},
		["HealthGlobe_pos"] = {
		...
		["focus_DEBUFFS"] = true,
		["ACTIVE_PROFILE"] = 0,
		["profileLastUpdated"] = "03/05/21 01:13:55",
